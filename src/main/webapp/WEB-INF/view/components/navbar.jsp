...
<div class="container-fluid">
  ...
  <a class="navbar-brand" href="/"><span style="border: 4px solid white; padding:5px">Pizza's House</span></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <!--   <form class="form-inline my-2 my-lg-0" action="searchfood">
      ...
      <button type="submit" class="btn btn-light" style="color:#000000"><b>Search</b></button>
    </form>
    -->
          ...
          <ul class="navbar-nav ml-auto">
              ...
              %>
                     <li class="nav-item active" data-toggle="modal" data-target="#showmycartmodal">
                        <div class="nav-link text-color"><b>Cart</b><!--  <img src="resources/images/cart.png" style="width:23px;" alt="img"><%-- (<%=cartDao.countByUserId(user.getId()) %>) --%>--></div>
                     </li>
...
<div class="modal fade" id="showprofilemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <div class="container text-center">
       <button type="button" class="btn bg-dark text-light" data-dismiss="modal">Close</button>
  </div>   
</form>
      </div>
    </div>
...
<div class="text-center row ml-5">
            <div class="mid-align"><a href="checkout"><button type="button" class="btn btn-success">Order</button></a></div>
...
<div class="modal fade logout-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
    <div class="modal-header bd-dark text-black text-center">
    ...
    <div class="modal-body text-center">
          ...
          <div class="text-center">
            <a href="logout"><button type="button" class="btn bg-danger text-white">Yes</button></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              Online pizza delivery services through the app/web give comfortable access to people to get their pizza served on their table within just 20-30 minutes. This service allows customers to pick from different flavours of pizza from their favourite restaurant and with the pizza constructor feature they can customize their pizza by adding toppings, spices, ingredients etc. according to their taste, and place an order.
          </b>
        </p>
        </div>
      </div>
